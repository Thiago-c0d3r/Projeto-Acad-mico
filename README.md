# 🚀 Projeto Integrador: Diagnóstico e Modernização Tecnológica

![Status](https://img.shields.io/badge/Status-Em%20Andamento-yellow)
![Curso](https://img.shields.io/badge/Curso-Engenharia%20de%20Software-blue)
![Instituição](https://img.shields.io/badge/Institui%C3%A7%C3%A3o-UNICEPLAC-green)

**Período de Execução:** 28/07/2026 a 24/11/2026  
**Professor Orientador:** Msc Valmir de Lima Severiano

---

## 📍 Painel de Status / Fase Atual

* **Fase Atual:** Realizar diagnóstico organizacional / Entregas 1º Bimestre
* **Onde estamos:** Fluxogramas mapeados (atividades até 06/09 concluídas).
* **Foco imediato (07/09):** Isabele e Kauã precisam identificar gargalos e redundâncias.
* **Meta da semana:** Concluir as entregas do 1º Bimestre e postar no GPA (até 08/09).
...
| Nome | Função / Papel |
|---|---|
| **Leandro Martinho Florêncio Rodrigues** | Líder de Projeto |
| **Ghabriell Sousa Tomaz** | Vice-Líder |
| **Victor Garcia Peres de Melo** | Secretário |
| **Ian Lucas Mendes Santos** | Integrante |
| **Gabriel Rodrigues de Carvalho** | Integrante |
| **Igor Roberto Silva Lopes** | Integrante |
| **Isabele Rodrigues Matos** | Integrante |
| **Jairo Silva Dias** | Integrante |
| **Kaua Lima Melgaço** | Integrante |
| **Luan Vidal Teixeira** | Integrante |
| **Lucas Macedo Gomes** | Integrante |
| **Thiago de Sousa Oliveira** | Integrante |
| **Vinícius Lima Alves Barroso** | Integrante |
...
* **Diagnóstico & Análise:** Matriz SWOT, Matriz GUT, Gráfico de Pareto, Diagrama de Ishikawa, CMMI, BSC, Canvas de Modelo de Negócio.
* **Planejamento & Execução:** Metodologia 5W2H.
* **Ferramentas de Gestão:** GitHub, Trello, GPA (Plataforma Acadêmica).
